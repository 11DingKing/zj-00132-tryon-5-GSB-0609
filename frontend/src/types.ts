export type TaskStatus = 'PENDING' | 'QUEUED' | 'PROCESSING' | 'COMPLETED' | 'FAILED' | 'RESHOOT_PENDING'
...
export type ReviewTag = 'FIT' | 'SIZE_ISSUE' | 'CLIPPING' | 'LIGHTING_ISSUE' | 'COLOR_DISTORTION'
